...
<div class="main-content px-4 sm:px-6 lg:px-8 py-6 max-w-[1800px] mx-auto">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        ...
        <div class="lg:col-span-1 flex flex-col gap-4 animate-slide-up" style="animation-delay: 130ms">
            ...
            <div class="rounded-premium border-2 border-dashed border-emerald-300 bg-gradient-to-br from-emerald-50/80 via-white to-emerald-50/30 shadow-sm overflow-hidden">
                <div class="px-4 sm:px-5 pt-4 pb-2 border-b border-emerald-200/70 flex items-center justify-between gap-2 flex-wrap">
                    <div class="flex items-center gap-2">
                        <span class="w-9 h-9 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-600">
                            <i class="fas fa-solar-panel text-lg"></i>
                        </span>
                        <div>
                            <h3 class="font-display text-lg font-black text-emerald-900">Produksi Solar Panel</h3>
                            <p class="text-[11px] font-bold text-emerald-700/80 mt-0.5">Status Pemasangan 2026</p>
                        </div>
                    </div>
                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-amber-50 border-2 border-amber-200 text-amber-700 text-[10px] font-black uppercase tracking-wider shrink-0">
                        <i class="fas fa-hourglass-half text-amber-500 mr-0.5"></i> Belum Terpasang
                    </span>
                </div>
                <div class="px-4 sm:px-5 py-4">
                    <!-- Big Visual Produksi 0 -->
                    <div class="rounded-2xl bg-white border border-emerald-200/60 p-3 sm:p-4 mb-3 shadow-sm">
                        <div class="flex items-end justify-between gap-3 mb-3">
                            <div>
                                <p class="text-[10px] font-black uppercase tracking-wider text-slate-500">Produksi Hari Ini</p>
                                <p class="font-display text-2xl sm:text-3xl font-black text-emerald-900 leading-none mt-1">0.00<span class="text-base font-bold text-slate-400 ml-1">kWh</span></p>
                            </div>
                            <div class="w-14 h-14 rounded-2xl bg-emerald-500/10 border-2 border-emerald-500/20 flex items-center justify-center shrink-0">
                                <i class="fas fa-plug-circle-xmark text-emerald-500 text-2xl"></i>
                            </div>
                        </div>
            ...
            <div class="rounded-premium border border-slate-200 bg-white shadow-sm overflow-hidden">
